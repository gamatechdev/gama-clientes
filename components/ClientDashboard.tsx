                ...
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-8 w-full">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
                      {indicators.map((ind, idx) => (
                         <div key={idx} className={`p-8 rounded-2xl bg-white border border-gray-200 shadow-[0_4px_20px_rgba(0,0,0,0.03)] flex items-center gap-6 hover:-translate-y-1 transition-transform duration-300`}>
